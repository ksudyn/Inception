...
# o se monta un volumen vacío, MariaDB podrá escribir sin errores.
...
# 												para el usuario root como "normal",
#												lo que permite usar una contraseña en lugar
...
# mysqld & 	-> arranca MariaDB en segundo plano para poder configurar la base de datos
# de wordpress (crear base de datos y usuarios).
# Esta parte no se ejecutará en futuros reinicios del contenedor porque se crea el archivo
...
# WP_DATABASE				->	Nombre de la base de datos de WordPress
# WPDB_USER					->	Usuario normal de WordPress
# WPDB_ROOT_USER			->	Usuario root lógico de WordPress
# WPDB_USER_PASSWORD_FILE	->	Ruta del secret con la contraseña del usuario normal
# WPDB_ROOT_PASSWORD_FILE	->	Ruta del secret con la contraseña del root de WordPress
# MDB_ROOT_PASSWORD_FILE	->	Ruta del secret con la contraseña del root de MariaDB
